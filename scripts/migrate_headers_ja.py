...
def main() -> int:
    ...
    examples = [
        ph,
        ["例1",  "takumi_kojo_navi", "2026-06-16 21:00", "今日のひとこと。◯◯について話します。",     "TEXT", "", "",     "", "", "", "", ""],
        ["例T1", "takumi_kojo_navi", "2026-06-16 21:30", "①導入：◯◯で悩んでいませんか？",            "TEXT", "", "",     "", "", "", "", ""],
        ["例T2", "takumi_kojo_navi", "2026-06-16 21:31", "②本題：実は△△が効きます。",                "TEXT", "", "例T1", "", "", "", "", ""],
        ["例T3", "takumi_kojo_navi", "2026-06-16 21:32", "③締め：詳しくはプロフィールから。",          "TEXT", "", "例T2", "", "", "", "", ""],
    ]
    try:
        ex = sh.worksheet("記入例")
        ex.clear()
